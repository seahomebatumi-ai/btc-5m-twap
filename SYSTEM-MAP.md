...
**Revision 2026-09-14-b.** Written by the Architect; the Executor never edits it. This is a
...
**Files on `main`:** seventeen TZ files (`TZ-01` … `TZ-10`), seventeen reports, ten `research/`
scripts, six `research/recorder/` files, two governance files, `.gitignore` — 53 paths in all.
